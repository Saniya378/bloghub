        ...
        <div class="app-branding">
            <a class="app-logo" href="{{ url('/dashboard') }}">
                <img class="logo-icon me-2"
                    src="{{ asset('assets/backend/images/app-logo.svg') }}"
                    alt="logo">
                    ...
                    <a class="nav-link" href="{{ url('/help') }}">
                        ...
                        <span class="nav-icon">
                            <svg width="1em" height="1em" viewBox="0 0 16 16"
                                ...
                                <path
                                    d="M5.255 5.786a.237.237 0 0 0 .241.247h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286zm1.557 5.763c0 .533.425.927 1.01.927 0 0 .0 0 0 0-.609 0-1.028-.394-1.028-.927-.0-.552.42-.94 1.029-.94-.584 0-1.009.388-1.009.94z" />
                            </svg>
                        </span>
                        ...
                        <a class="nav-link" href="{{ url('/settings') }}">
                            ...
                            <span class="nav-icon">
                                <svg width="1em" height="1em" viewBox="0 0 16 16"
                                    ...
                                    <path fill-rule="evenodd"
                                        d="M8.837 1.626c-.246-.835-1.428-.835-1.674 0l-.094.319A1.873 1.873 0 0 1 4.377 3.06l-.292-.16c-.764-.415-1.6.42-1.184 1.185l.159.292a1.873 1.873 0 0 1-1.115 2.692l-.319.094c-.835.246-.835 1.428 0 1.674l.319.094a1.873 1.873 0 0 1 1.115 2.693l-.16.291c-.415.764.42 1.6 1.185 1.184l.292-.159a1.873 1.873 0 0 1 2.692 1.116l.094.318c.246.835 1.428.835 1.674 0l.094-.319a1.873 1.873 0 0 1 2.693-1.115l.291.16c.764.415 1.6-.42 1.184-1.185l-.159-.291a1.873 1.873 0 0 1 1.116-2.693l.318-.094c.835-.246.835-1.428 0-1.674l-.319-.094a1.873 1.873 0 0 1-1.115-2.692l.16-.292c-.892-1.64.902-3.433 2.541-2.54l.292.159A1.873 1.873 0 0 1 8.93 1.945l-.094-.319z" />
